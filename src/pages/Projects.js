  ...
  return (
    <span>
      <div >
        ...
        <Item name={"Meals on Wheel Volunteer Application"} place={<a href="https://gregarious-dolphin-16199a.netlify.app/">Netifly</a>} picture={secondImage} description={"Using Node and Express, worked as a backend developer to write routes to a PostgreSQL database."}/>
